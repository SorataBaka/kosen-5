...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{plotted_self_data.eps}
  \caption{自作学習データのプロット}
\end{figure}
\begin{table}[H]
  \centering
...
\begin{verbatim}
  self:
    ...
    1.2 -7 2 0 weights-self-1.dat logs-self-1.dat
    python3 percep_main.py mydata.dat mytest.dat
    3.6 -7 2 0 weights-self-2.dat logs-self-2.dat
    python3 percep_main.py mydata.dat mytest.dat
    2.0 11 5 0 weights-self-3.dat logs-self-3.dat
